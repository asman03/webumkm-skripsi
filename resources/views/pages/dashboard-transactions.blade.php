      ...
      <div class="container-fluid">
        <div class="dashboard-heading">
          ...
          <p class="dashboard-subtitle">
            Hasil yang besar dimulai dari hal terkecil
          </p>
        </div>
      </div>
        ...
        <div class="row mt-3">
          <div class="col-12 mt-2">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Pembelian</a>
              </li>  
            </ul>
